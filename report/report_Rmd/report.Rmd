...
# Result  
## Objective 1: analysis of the risk factor of death  
```{r some_prereq}
require(kableExtra) ## make great table 
...
![Figure 2](../figs/KM_fig1.png)  

![Figure 3](../figs/KM_fig2.png)  

![Figure 4](../figs/KM_fig3.png)  
...
multi_analysis <- data %>%
  ...
  kable(caption="Table 3. Adjusted Survival model")
multi_analysis
```

### Objective 2: find the treatment and the expectation
Generally, the treatment could be different because of the tumor stage. Here the surgery type and tumor stage are highlt correlated.  
...
Just compare the mean effect of surgery type for different groups  
