...
This data analysis will be completed with R 3.6 r-packages included: "DataExplorer", "table1", "car", "reshape2", "ggplot2" Just run the code, and you don't have to install these packages.
...
```
Rscript -e "rmarkdown::render('Quick_view.Rmd')"
```
